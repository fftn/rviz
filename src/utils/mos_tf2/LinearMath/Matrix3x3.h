...
public:
	...
	*/
	MOS_DEPRECATED void setEulerZYX(const tf2Scalar& yaw, const tf2Scalar& pitch, const tf2Scalar& roll)
	{
		setEulerYPR(yaw, pitch, roll);
	}
	...
	* @param roll around X axis 
	...
	MOS_DEPRECATED void getEulerZYX(tf2Scalar& yaw, tf2Scalar& pitch, tf2Scalar& roll, unsigned int solution_number = 1) const
	{
