...
struct TimeReference_
{
  ...
  _header_type header;
   ...
   typedef mos::Time _time_ref_type;
...
{
mos::message_operations::Printer< ::sensor_msgs::TimeReference_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
struct Printer< ::sensor_msgs::TimeReference_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::sensor_msgs::TimeReference_<ContainerAllocator>& v)
  {
    ...
    s << indent << "time_ref: ";
    Printer<mos::Time>::stream(s, indent + "  ", v.time_ref);
    s << indent << "source: ";
